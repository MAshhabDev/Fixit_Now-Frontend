      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="border-b border-border pb-3">
          ...
          <p className="text-xs text-muted-foreground">
            Monitor and track all customer service orders across the platform.
          </p>
        </div>
                    ...
                    return (
                      <tr key={item.id} className="hover:bg-accent/30">
                        ...
                        <td className="p-3 font-bold text-foreground">
                          {item.service?.title || "Service Repair"}
                        </td>

                        {/* 3. Technician */}
                        <td className="p-3 font-semibold text-primary">
                          {item.technician?.user?.name || "Assigned Tech"}
                        </td>
                        ...
                        {/* 5. Total Amount */}
                        <td className="p-3 font-bold text-foreground">
                          ৳{item.totalAmount || item.service?.price || 0}
                        </td>
                        ...
                        {/* 🟢 7. Action Column: Booking Details Modal */}
