...
export default function CustomerBookingListUI({ bookings = [] }: CustomerBookingListProps) {
              ...
              >
                ...
                <div className="space-y-1.5 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase border border-border ${
                  ...
                  <p className="text-muted-foreground flex items-center gap-1">
                    ...
                    <span>Date: {booking.bookingDate} ({booking.timeSlot})</span>
                  </p>
