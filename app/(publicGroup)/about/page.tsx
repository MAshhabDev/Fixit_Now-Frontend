      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground leading-relaxed">
            FixItNow is Bangladesh’s leading digital platform connecting homeowners with certified, background-checked technicians for electrical, plumbing, AC servicing, and appliance repairs.
          </p>
        </div>
